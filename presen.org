...
(LET* ((#:*LENGTH-VARIABLE*844 (LENGTH B))
  ...
  (LET* ((#:G846 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G845 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G848 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G849 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G854 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G855 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G860 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G861 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G866 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G867 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G872 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G871 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G868 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G865 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G862 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G859 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G856 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G853 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844))
         (#:G850 (MAKE-BIT-VECTOR #:*LENGTH-VARIABLE*844)))
    (DECLARE
     (DYNAMIC-EXTENT #:G846 #:G845 #:G848 #:G849 #:G854 #:G855 #:G860 #:G861
      #:G866 #:G867 #:G872 #:G871 #:G868 #:G865 #:G862 #:G859 #:G856 #:G853
      #:G850))
    (BIT-REPLACE A 5 #:G845)
    (BIT-REPLACE B 5 #:G846)
    (BIT-XOR #:G845 #:G846 #:G845)
    (BIT-REPLACE A 4 #:G848)
    (BIT-REPLACE B 4 #:G849)
    (BIT-AND #:G848 #:G849 #:G850)
    (BIT-XOR #:G848 #:G849 #:G853)
    (BIT-REPLACE A 3 #:G854)
    (BIT-REPLACE B 3 #:G855)
    (BIT-AND #:G854 #:G855 #:G856)
    (BIT-XOR #:G854 #:G855 #:G859)
    (BIT-REPLACE A 2 #:G860)
    (BIT-REPLACE B 2 #:G861)
    (BIT-AND #:G860 #:G861 #:G862)
    (BIT-XOR #:G860 #:G861 #:G865)
    (BIT-REPLACE A 1 #:G866)
    (BIT-REPLACE B 1 #:G867)
